...
set_attr source_files [list MA_filter.cpp] [get_design]
set_attr header_files [list MA_filter.h] [get_design]
set_attr compile_flags " -w" [get_design]
set_attr top_module_path "MA_filter" [get_design]
...
build
schedule -passes 200 [get_design]/modules/MA_filter
allocate_registers 
write_rtl -dir top/rtl [get_design]/modules/MA_filter
